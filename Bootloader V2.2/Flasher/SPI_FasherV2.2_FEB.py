# 02/05 Flasher SPI avec protocole de communication S19 adapté communicant en réseau avec la FEB
    ...
    def Flash_write_from_file(self) :
        ...
        while flag != 1 :
            ...
            if (f.read(2) == "S7") :
                ...
                self.Send_one_word(310, 0)  #Commande read status
                ...
                self.Send_one_word(310, 0) #Commande read status
                self.Send_one_word(330, 0) #Commande read checksum
